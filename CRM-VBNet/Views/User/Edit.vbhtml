@* =============================================
   User/Edit.vbhtml - Formulario para editar usuario
   ============================================= *@
...
<div class="page-header">
    <div>
        ...
        <p class="text-muted">Modificar información de @Model.FirstName @Model.LastName</p>
    </div>
                    ...
                    <select id="RoleId" name="RoleId" class="form-control" required>
                        @If roles IsNot Nothing Then
                            @For Each role In roles
                                @<option value="@role.Id" @If role.Id = Model.RoleId Then @:selected End If>
                ...
                <div class="form-group">
                    <label class="checkbox-label">
                        <input type="checkbox" name="IsActive" value="true"
                               @If Model.IsActive Then @:checked End If />
