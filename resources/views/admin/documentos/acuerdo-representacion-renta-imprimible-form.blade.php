...
@section('title', 'Versión imprimible — Acuerdo de Representación (Renta)')
...
<div style="margin-bottom:1.25rem;">
    <h2 style="margin:0;font-size:1.3rem;">Versión imprimible — Acuerdo de Representación (Renta)</h2>
    <p style="margin:0.2rem 0 0;color:var(--text-muted);font-size:0.85rem;">
        Opcionalmente elige un cliente y un inmueble del CRM para prellenar sus datos. Identidad del propietario, escritura, folio real, notario, renta y fecha siempre quedan en blanco para llenarse a mano — es justo la información que se recaba en ese momento.
    </p>
</div>

<form method="POST" action="{{ route('admin.documentos.contrato-exclusiva-renta.imprimible.generate') }}" target="_blank">
    @csrf

    <div class="flash-card">
        <div class="flash-grid">
            <div>
                <label for="client_id">Cliente (propietario) — opcional</label>
