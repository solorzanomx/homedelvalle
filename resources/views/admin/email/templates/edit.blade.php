...
<div class="page-header">
    <div><h2>Editar: {{ $template->name }}</h2></div>
    <div style="display:flex; gap:0.5rem;">
        <a href="{{ route('admin.email.templates.preview', $template) }}" class="btn btn-outline" target="_blank">&#9673; Preview</a>
            ...
            <div class="card">
                ...
                <div class="card-body" style="padding-top:0.75rem;">
                    ...
                    <div class="editor-panel active" id="panel-visual">
                        <textarea id="wysiwygEditor">{{ old('body', $template->body) }}</textarea>
                    </div>

                    {{-- HTML Code --}}
                    <div class="editor-panel" id="panel-html">
                        <textarea name="body" id="bodyHtml" class="form-textarea" required
                                  style="font-family:monospace; font-size:0.82rem; min-height:400px;">{{ old('body', $template->body) }}</textarea>
                    ...
                    <div class="editor-panel" id="panel-text">
                        ...
                        <textarea name="body_text" id="bodyText" class="form-textarea"
                                  style="font-family:monospace; font-size:0.82rem; min-height:350px;">{{ old('body_text', $template->body_text) }}</textarea>
                    </div>
