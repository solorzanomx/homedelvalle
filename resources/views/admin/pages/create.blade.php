...
<div class="page-header">
    <div>
        <h2>Nueva Pagina</h2>
        <p class="text-muted">Crear una nueva pagina estatica</p>
    </div>
...
<div class="card">
    <div class="card-body">
        <form method="POST" action="{{ route('admin.pages.store') }}">
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="text" name="title" id="titleInput" class="form-input" value="{{ old('title') }}"
                           required placeholder="Titulo de la pagina" oninput="generateSlug(this.value)">
                </div>

                <div class="form-group">
                    <label class="form-label">Slug <span class="required">*</span></label>
                    <input type="text" name="slug" id="slugInput" class="form-input" value="{{ old('slug') }}"
                           required placeholder="url-de-la-pagina">
                ...
                <div class="form-group full-width">
                    ...
                    <textarea name="body" id="wysiwygEditor" class="form-textarea" rows="15" required
                              placeholder="Escribe el contenido de la pagina...">{{ old('body') }}</textarea>
                </div>
            ...
            @include('admin.pages._nav-fields', ['page' => null])

            @include('admin.pages._section-builder', ['page' => (object)['use_sections' => false, 'sections' => null]])

            @include('admin.pages._landing-fields', ['page' => (object)['is_landing' => false, 'landing_settings' => null]])
