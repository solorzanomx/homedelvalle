...
<table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;">
  ...
  <tr><td style="background:#fff;border-radius:16px;border:1px solid #E6EAF1;padding:40px 36px;box-shadow:0 2px 16px rgba(0,0,0,.06);">
    ...
    <p style="font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:.8px;color:#1D4ED8;margin:0 0 12px;">Tu Inmueble</p>
    <h1 style="font-size:22px;font-weight:800;color:#0E304B;margin:0 0 12px;line-height:1.3;">Visita confirmada ✓</h1>
    <p style="font-size:15px;color:#5A6573;line-height:1.6;margin:0 0 24px;">
      Un interesado ha confirmado su asistencia a la visita de tu inmueble.
    </p>

    {{-- Details --}}
    <table width="100%" cellpadding="0" cellspacing="0" style="background:#F6F8FB;border-radius:12px;padding:18px 20px;margin-bottom:28px;">
      @if($interaction->scheduled_at)
      <tr>
        <td style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.5px;color:#9AA6B5;padding-bottom:4px;">Fecha y hora</td>
      </tr>
      <tr>
        <td style="font-size:15px;font-weight:700;color:#0E304B;padding-bottom:14px;">
      ...
      <tr>
        <td style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.5px;color:#9AA6B5;padding-bottom:4px;">Inmueble</td>
      </tr>
      <tr>
        <td style="font-size:14px;font-weight:600;color:#0E304B;">
          {{ $interaction->property->address }}
          @if($interaction->property->colony), {{ $interaction->property->colony }}@endif
        </td>
      </tr>
      @endif
    </table>
