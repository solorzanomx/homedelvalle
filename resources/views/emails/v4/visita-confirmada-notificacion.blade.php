...
<title>Visita confirmada — {{ $interaction->client?->name ?? 'Cliente' }}</title>
...
{{-- Preheader --}}
<div style="display:none;max-height:0;overflow:hidden;mso-hide:all;font-size:1px;line-height:1px;color:#F1F4F8;">{{ $name }} confirmó su asistencia{{ $scheduled ? ' para hoy a las ' . $scheduled->format('H:i') . ' h' : '' }}.</div>
    ...
    <tr>
        <td class="px" align="center" style="padding:34px 34px 0;">
                ...
                <tr>
                    <td width="64" align="center">
                        <table width="64" cellpadding="0" cellspacing="0" border="0"
                               style="background:#D1FAE5;border-radius:32px;">
                            <tr>
                                <td align="center" valign="middle" height="64"
                                    style="height:64px;color:#065F46;font-size:22px;font-weight:800;font-family:'Plus Jakarta Sans',-apple-system,'Segoe UI',Arial,sans-serif;">
                                    {{ $iniciales }}
                                </td>
                            </tr>
                        </table>
            ...
            <table cellpadding="0" cellspacing="0" border="0" style="margin:18px auto 0;">
                <tr>
                    <td style="background:#D1FAE5;border-radius:999px;padding:6px 13px;font-size:11.5px;font-weight:800;letter-spacing:1.5px;color:#065F46;text-transform:uppercase;font-family:'Plus Jakarta Sans',-apple-system,'Segoe UI',Arial,sans-serif;">
                        ✓ Visita confirmada
                    </td>
                </tr>
            </table>
            ...
            <p style="font-size:14.5px;color:#7A8594;margin:7px 0 0;font-weight:500;font-family:'Plus Jakarta Sans',-apple-system,'Segoe UI',Arial,sans-serif;">
                Confirmó que asistirá a la visita de hoy
            </p>
        </td>
    </tr>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0"
                ...
                <tr>
                    <td style="padding:15px 20px;border-bottom:1px solid #F1F4F8;">
                        <table width="100%"><tr>
                            <td width="130" valign="middle" style="width:130px;font-size:11px;font-weight:800;letter-spacing:.8px;text-transform:uppercase;color:#9AA6B5;font-family:'Plus Jakarta Sans',-apple-system,'Segoe UI',Arial,sans-serif;">Hora</td>
                ...
                <tr>
                    <td style="padding:15px 20px;">
                        <table width="100%"><tr>
                            <td width="130" valign="middle" style="width:130px;font-size:11px;font-weight:800;letter-spacing:.8px;text-transform:uppercase;color:#9AA6B5;font-family:'Plus Jakarta Sans',-apple-system,'Segoe UI',Arial,sans-serif;">Confirmado el</td>
                            <td valign="middle" style="font-size:14.5px;font-weight:700;color:#0E304B;font-family:'Plus Jakarta Sans',-apple-system,'Segoe UI',Arial,sans-serif;">
