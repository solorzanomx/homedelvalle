        ...
        <td class="px" style="padding:28px 34px 34px;">
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    ...
                    <td class="stack" valign="top">
                        <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ $calendarUrl }}" style="height:52px;v-text-anchor:middle;width:240px;" arcsize="24%" strokecolor="#2270B0" strokeweight="1.5px" fillcolor="#FFFFFF"><w:anchorlock/><center style="color:#2270B0;font-family:Arial,sans-serif;font-size:15px;font-weight:bold;">Cómo llegar</center></v:roundrect><![endif]-->
                        <!--[if !mso]><!-->
                        <a href="{{ $calendarUrl }}"
                           style="display:block;background:#FFFFFF;border:1.5px solid #2270B0;border-radius:12px;color:#2270B0;font-family:'Plus Jakarta Sans',-apple-system,'Segoe UI',Arial,sans-serif;font-size:15px;font-weight:700;line-height:50px;text-align:center;text-decoration:none;">
                            📍 Cómo llegar
                        </a>
                        <!--<![endif]-->
                    </td>
