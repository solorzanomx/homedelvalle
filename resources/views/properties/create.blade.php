                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" class="form-select">
                            ...
                            <option value="archived" {{ old('status') === 'archived' ? 'selected' : '' }}>Archivada (fuera del sitio)</option>
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="market_colonia_id" class="form-input">
                            ...
                            @foreach($colonias ?? [] as $zona => $cols)
                                <optgroup label="{{ $zona }}">
                                    @foreach($cols as $col)
                                        <option value="{{ $col->id }}" {{ old('market_colonia_id') == $col->id ? 'selected' : '' }}>{{ $col->name }}</option>
                                    @endforeach
                                </optgroup>
                            @endforeach
                        </select>
