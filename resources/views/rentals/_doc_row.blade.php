{{-- Una fila de documento. Espera: $doc, $catKey, $catLabel. Opcional: $rental, $inbox (bandeja central). Usada por rentals/_doc_category y documents/inbox --}}
@php
...
<div class="doc-item" id="docrow-{{ $doc->id }}"
    ...
    <div class="doc-actions">
        ...
        @if($catKey === 'comprobante_apartado' && isset($rental) && $rental && ! $rental->apartado_paid_at)
