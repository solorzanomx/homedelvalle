                ...
                @else
                    ...
                    <div style="display:flex;align-items:center;gap:.75rem;background:#EFF6FF;border:1px solid #BFDBFE;border-radius:8px;padding:.75rem 1rem;margin-bottom:1rem;">
                        ...
                        <a href="{{ route('documents.download', $comprobanteApartado->id) }}" target="_blank">
                            <img src="{{ route('documents.preview', ['document' => $comprobanteApartado->id, 'thumb' => 1]) }}" style="width:56px;height:56px;object-fit:cover;border-radius:6px;border:1px solid var(--border);">
                        </a>
                        @endif
                        <div style="flex:1;">
                    ...
                    <form method="POST" action="{{ route('rentals.apartado.store', $rental->id) }}">
                        ...
                        <div style="display:flex;gap:.65rem;flex-wrap:wrap;align-items:flex-end;">
                            <div class="form-group" style="margin:0;min-width:140px;">
                                ...
                                <input type="number" step="0.01" min="0" name="apartado_amount" class="form-input" required>
                            </div>
                            ...
                            <div class="form-group" style="margin:0;min-width:150px;">
                                ...
                                <select name="apartado_payment_method" class="form-select">
                                    <option value="">— Seleccionar —</option>
                                    @foreach(\App\Models\RentalProcess::APARTADO_PAYMENT_METHODS as $key => $label)
