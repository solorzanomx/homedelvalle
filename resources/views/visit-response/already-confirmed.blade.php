...
<title>Ya confirmado — Home del Valle</title>
...
.icon{display:block;width:72px;height:72px;border-radius:50%;background:#ECFDF5;margin:0 auto 24px;line-height:72px;font-size:30px;color:#10B981;text-align:center;}
h1{font-size:22px;font-weight:800;color:#0E304B;margin-bottom:12px;letter-spacing:-.3px;}
.subtext{font-size:15px;color:#5A6573;line-height:1.6;}
...
<div class="card">
    ...
    <h1>Tu asistencia ya estaba registrada</h1>
    <p class="subtext">¡Te esperamos! Ya tenemos tu confirmación y tu asesor estará listo para recibirte.</p>
