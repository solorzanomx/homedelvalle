    ...
    @if ($submitted)
        <div class="bg-green-50 border border-green-200 rounded-xl p-6 mb-6">
            <div class="flex gap-3">
                ...
                <div>
                    <h3 class="font-semibold text-green-900">Recibimos tu brief, {{ $nombre_rol }}!</h3>
                    <p class="text-green-800 text-sm mt-1">Un miembro de nuestra dirección general te contactará en menos de 48 horas hábiles para agendar una llamada de calificación.<br>Información tratada bajo confidencialidad.</p>
                </div>
            </div>
        </div>
    @else
