...
<title>Autorización confirmada — Home del Valle</title>
...
h1{font-size:23px;font-weight:800;color:#0E304B;margin-bottom:12px;letter-spacing:-.4px;}
.subtext{font-size:15.5px;color:#5A6573;line-height:1.65;margin-bottom:10px;}
...
<div class="card">
    ...
    <h1>¡Gracias, {{ explode(' ', trim($collaborator->name))[0] }}!</h1>
    <p class="subtext">Quedó registrada tu autorización. En breve verás tu perfil en homedelvalle.mx, y te acabamos de mandar un correo con una copia de lo que autorizaste, por si lo necesitas.</p>
    <p class="subtext">Cuando quieras que lo bajemos, solo escríbenos.</p>
