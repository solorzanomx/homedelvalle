...
@section('meta')
    <x-public.seo-meta
        title="Contacto"
        description="Contacta a los especialistas inmobiliarios de Benito Juárez. Opinión de valor gratuita, asesoría sin costo y respuesta en menos de 24 horas. Ubicados en Del Valle, CDMX."
