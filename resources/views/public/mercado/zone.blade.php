...
<section style="background:#ecfdf5;border-top:1px solid #a7f3d0;padding:2.2rem 1.5rem;text-align:center;">
    <div style="max-width:600px;margin:0 auto;">
        <h2 style="font-size:1.1rem;font-weight:700;color:#065f46;margin-bottom:.5rem;">
            ¿Sabías que tu casa en {{ $zone->name }} podría valer más como terreno?
        </h2>
