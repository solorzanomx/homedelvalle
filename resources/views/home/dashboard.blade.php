...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        nav h1 { font-size: 24px; color: #667eea; font-weight: 600; }
        nav-right { display: flex; gap: 15px; align-items: center; }
        nav a, nav button { background: white; color: #667eea; padding: 8px 16px; border: 1px solid #e3e3e0; border-radius: 4px; text-decoration: none; cursor: pointer; font-weight: 600; transition: all 0.2s; }
        nav a:hover, nav button:hover { background: #667eea; color: white; border-color: #667eea; }
        ...
        .card-image { width: 100%; height: 200px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); display: flex; align-items: center; justify-content: center; color: white; font-size: 24px; }
        ...
        .card-price { font-size: 20px; font-weight: 600; color: #667eea; margin-bottom: 15px; }
        .btn { padding: 10px 16px; background: #667eea; color: white; border: none; border-radius: 4px; cursor: pointer; text-decoration: none; font-size: 14px; font-weight: 600; transition: all 0.2s; display: inline-block; }
    ...
    <div class="container">
        ...
        @else
            <div class="empty-state">
                ...
                <p>Comienza <a href="{{ route('properties.create') }}" style="color: #667eea; font-weight: 600;">creando una nueva propiedad</a></p>
            </div>
        @endif
