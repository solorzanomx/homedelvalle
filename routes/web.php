...
// Slug map: slugs DB viejos → nuevos (narvarte-piedad era el slug anterior de Narvarte)
Route::get('/mercado', fn() => redirect('/precios', 301));
Route::get('/mercado/opinion-de-valor', fn() => redirect('/precios/opinion-de-valor', 301));
...
Route::middleware(['auth', 'viewer'])->group(function () {
    ...
    Route::post('clients/{client}/reset-legal-acceptance', [ClientController::class, 'resetLegalAcceptance'])->name('clients.reset-legal-acceptance');
    ...
    Route::resource('providers', \App\Http\Controllers\ProviderCompanyController::class);
    ...
    Route::delete('provider-charges/{charge}', [\App\Http\Controllers\ProviderChargeController::class, 'destroy'])->name('provider-charges.destroy');
...
Route::middleware(['auth', 'viewer'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::get('/easybroker/properties', [EasyBrokerSettingsController::class, 'properties'])->name('easybroker.properties');
        Route::post('/easybroker/sync-leads', [EasyBrokerSettingsController::class, 'syncLeads'])->name('easybroker.sync-leads');
        Route::post('/easybroker/classify-leads', [EasyBrokerSettingsController::class, 'classifyLeads'])->name('easybroker.classify-leads');
