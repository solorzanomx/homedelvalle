...
class AcuerdoRepresentacionRentaGeneratorService
{
    ...
    const DEFAULT_CLAUSES = [
        ...
        'ofertas_referencia' => '<strong>Precio de Referencia y Recepción de Ofertas.</strong> Las partes reconocen que la renta mensual señalada en el presente Acuerdo constituye un precio de referencia para efectos de la promoción y colocación del inmueble, y no representa una condición fija, mínima ni inamovible. En consecuencia, Home del Valle queda expresamente facultado para recibir, evaluar y presentar al propietario cualquier oferta de arrendamiento formulada por candidatos interesados, ya sea igual, superior o inferior al monto de referencia pactado. Corresponderá exclusivamente al propietario, en cada caso, la decisión de aceptar, rechazar o contraofertar dicha propuesta, sin que la sola presentación de una oferta por parte de Home del Valle genere obligación alguna de aceptarla ni responsabilidad para Home del Valle derivada de la decisión del propietario. Ninguna oferta se entenderá aceptada hasta que medie manifestación expresa de voluntad del propietario, formalizada en el contrato de arrendamiento respectivo.',
