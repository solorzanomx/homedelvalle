...
class CreateCaptacionFromCall extends Component
{
    ...
    private const MARKETING_DEFAULTS = [
        ...
        'renta_residencial' =>
            "• Calificación exhaustiva de candidatos (buró, comprobante, referencias)\n• Contrato de arrendamiento con cláusulas de protección al propietario\n• Garantías del arrendamiento — pagarés, aval, obligado solidario o póliza jurídica: definimos contigo el esquema más sólido según el caso\n• Administración de renta disponible como servicio opcional (10% mensual): cobro y conciliación mensual, reporte de pagos, atención de incidencias y seguimiento del contrato\n• Inspección de entrega y devolución documentada",
        'renta_comercial' =>
            "• Búsqueda segmentada de arrendatario según giro y perfil de riesgo\n• Contrato comercial con ajustes anuales y penalidades claras\n• Garantías del arrendamiento — fianza afianzadora, aval, obligado solidario o póliza jurídica: definimos contigo el esquema más sólido según el perfil del arrendatario\n• Revisión de uso permitido y restricciones de operación\n• Administración de renta disponible como servicio opcional (10% mensual): cobro y conciliación mensual, reporte de pagos, atención de incidencias y seguimiento del contrato\n• Seguimiento durante toda la vigencia del contrato",
    ];
