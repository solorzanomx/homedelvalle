...
class CreateCaptacionFromCall extends Component
{
    ...
    private const MARKETING_DEFAULTS = [
        ...
        'renta_residencial' =>
            "• Calificación exhaustiva de candidatos (buró, comprobante, referencias)\n• Contrato de arrendamiento con cláusulas de protección al propietario\n• Garantías del arrendamiento — aval, pagarés y pólizas de renta: analizamos el perfil del inquilino y sugerimos la opción que mejor protege tu patrimonio\n• Administración de renta disponible como servicio opcional (10% mensual): cobro puntual, reporte de pagos, atención de incidencias y visibilidad total en el Portal del Propietario\n• Inspección de entrega y devolución documentada",
        'renta_comercial' =>
            "• Búsqueda segmentada de arrendatario según giro y perfil de riesgo\n• Contrato comercial con ajustes anuales y penalidades claras\n• Garantías del arrendamiento — fianza afianzadora, aval y pólizas de renta: sugerimos siempre la opción que mejor protege tu patrimonio según el perfil del arrendatario\n• Revisión de uso permitido y restricciones de operación\n• Administración de renta disponible como servicio opcional (10% mensual): cobro puntual, reporte de pagos, atención de incidencias y visibilidad total en el Portal del Propietario\n• Seguimiento durante toda la vigencia del contrato",
    ];
